...
import { FilmSlateIcon, FileTextIcon, FlagIcon, UsersIcon, ChatsCircleIcon, SirenIcon, EnvelopeIcon } from "@phosphor-icons/react";
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="w-full grid grid-cols-8 bg-transparent border-b border-black/10 rounded-none p-0 h-auto">
