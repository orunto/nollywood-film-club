...
export default function BrowseContent({ allContent }: { allContent: Content[] }) {
    const { state, setParam, toggleFilter, resetFilters, pageHref } = useBrowseParams();
    ...
    return (
        <div className="flex flex-col gap-4 py-6">
            <Tabs value={state.filters.type ?? "all"} onValueChange={(value) => setParam({ type: value === "all" ? null : value })}>
            ...
            <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <Select value={state.sort} onValueChange={(value) => setParam({ sort: value })}>
                    ...
                    <Sheet>
                        ...
                        <SheetContent side="bottom" className="max-h-[85vh] overflow-y-auto px-6 pb-6">
