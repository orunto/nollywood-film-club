      ...
      <div className="max-w-md w-full space-y-8">
        <Tabs defaultValue="signup" className="w-full">
          <TabsList className="grid w-full grid-cols-2 h-max shadow-none rounded-sm">
            <TabsTrigger className="py-2 shadow-none rounded-sm" value="signup">
              Sign Up
            </TabsTrigger>
            <TabsTrigger className="py-2 shadow-none rounded-sm" value="signin">
              Sign In
            </TabsTrigger>
          </TabsList>
            ...
            <Card className="shadow-none rounded-sm">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background =
                        "linear-gradient(white, white) padding-box, linear-gradient(45deg, #4285F4, #34A853, #FBBC05, #EA4335) border-box";
                  ...
                  <Button
                    onClick={async () => await app.signInWithOAuth("x")}
                    variant="outline"
                    className="w-full shadow-none  hover:bg-black"
                  >
                    <svg
