...
const sections: LegalSection[] = [
  {
    ...
    content: (
      <p>
        Nollywood Film Club operates this Service and is responsible for the personal data described in this policy. Privacy questions and rights requests can be submitted through our <Link to="/contact">contact form</Link>.
      </p>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          When you sign in with Google or X, the provider and our authentication processor send us the account details you authorise. Password credentials are handled by the sign-in provider; Nollywood Film Club does not directly store your password in its application database.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li><strong>Database hosting</strong> for managed database services;</li>
          <li><strong>Application hosting</strong> for running the site; and</li>
          <li><strong>Image storage and delivery</strong> for posters and profile images.</li>
        </ul>
        <p>
  ...
  },
  {
    ...
    content: (
      <p>
        The Service uses cookies or similar browser storage where necessary to keep you signed in, protect sessions, and remember essential state. Analytics help us understand aggregate site use and performance. Your browser can restrict cookies, but blocking essential storage may prevent account features from working.
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Use the <Link to="/contact">contact form</Link> to make a request or ask for account deletion. Choose &quot;Something else&quot; and provide your account email or username, a reply email, and enough detail for us to understand the request. We may need to verify your identity before acting. Some information may be retained where the law permits or requires it.
        </p>
      </>
    ),
  },
