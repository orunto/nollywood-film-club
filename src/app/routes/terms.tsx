...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Some features require an account. You agree to provide accurate information, keep your sign-in method secure, and tell us through the <Link to="/contact">contact form</Link> if you believe your account has been compromised.
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Questions about these terms can be sent through our <Link to="/contact">contact form</Link>.
        </p>
      </>
    ),
  },
