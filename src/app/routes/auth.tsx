...
const buttonClass =
  "w-full rounded-sm bg-black px-4 py-2 text-sm font-semibold text-white hover:bg-black/80 disabled:cursor-not-allowed disabled:opacity-60";
...
export default function AuthPage() {
  ...
  const handleSocial = (provider: "google" | "twitter") => {
    setError(null);
    void authClient.signIn.social({ provider, callbackURL: "/auth/callback" });
  };

  return (
    <main className="min-h-screen flex items-start justify-center bg-gray-50 px-4 py-20 sm:px-6 lg:py-28">
      <div className="w-full max-w-md space-y-6">
        <div className="grid w-full grid-cols-2 gap-0 rounded-sm border border-black/20">
          <button
            type="button"
            onClick={() => {
              setTab("signup");
            ...
            className={`cursor-pointer rounded-sm px-4 py-2 text-sm font-semibold ${
              tab === "signup"
                ? "bg-black text-white"
        ...
        <section className="space-y-4 rounded-sm border border-black/10 bg-white p-6">
          <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center rounded-sm border border-black/20 bg-white px-4 py-2 text-sm font-medium hover:bg-black/5"
            >
            ...
            <button
              ...
              className="flex items-center justify-center rounded-sm border border-black/20 bg-white px-4 py-2 text-sm font-medium hover:bg-black hover:text-white"
            >
