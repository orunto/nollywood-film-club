...
import { EmptyReviewsIllustration } from "../graphics";
...
export default function ContentDetailsClient({
  ...
  // from anywhere — has a single history entry, so navigate(-1) would sit there
          ...
          <figure className="lg:col-span-4 aspect-video">
            ...
            >
              {!isPlaying ? (
                <>
                  <img
                    src={posterUrl(movie.posterImage || "nollywood-film-club/elj", {
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-1.5">
                        {userRating.profileUsername ? (
                          <Link to={`/members/${userRating.profileUsername}`} className="text-lg font-semibold hover:underline">
                            {userRating.username}
                          </Link>
                        ) : (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 py-6">
              {criticReviews.map((review) =>
                review.externalUrl ? (
                  ...
                  >
                    <img
                      src={posterUrl(review.reviewImage || "nollywood-film-club/elj", {
                        width: 400,
                        height: 225,
                      })}
