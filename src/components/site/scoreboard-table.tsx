...
import { SortableHead, useTableSort, type SortAccessors } from "../ui/table-sort";
            ...
            return (
              ...
              >
                ...
                <TableCell className={cn("py-1.5 whitespace-normal", cellBorder)}>
                  <Link to={contentPath(item)} className="flex items-center gap-2 group w-fit">
                    {item.posterImage && (
                      <img
                        src={posterUrl(item.posterImage, {
