...
interface MovieOfTheWeekClientProps {
    movie: Content | null;
}

export default function MovieOfTheWeekClient({ movie }: MovieOfTheWeekClientProps) {
        ...
        return (
            <section className="w-full">
                ...
                <div className="py-6 text-center">
                    <p className="text-gray-500">No movie of the week available</p>
                </div>
            </section>
        );
    }
